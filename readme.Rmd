...
#Overview
In this report we will validate the central limit theorem (CLT) via a huge random sample of exponential distribution. Briefly we will investigate the distribution of means of random samples of an exponential distribution and compare it to the normal distribution.
